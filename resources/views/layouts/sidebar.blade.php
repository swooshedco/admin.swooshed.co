            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('brandgroups.index') }}" class="sidebar-link">
                                <i class="mdi mdi-sort-variant"></i>
                                <span class="hide-menu"> Brand Group</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ asset('admin/docs/documentation.html') }}
                            " aria-expanded="false">
